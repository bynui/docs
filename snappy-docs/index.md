...
features:
  ...
  - title: Flexible Response Formats
    details: Automatically generate responses in JSON, JSONP, XML, CSV and HTML based on client request or configuration — ideal for APIs, web apps, or cross-domain data delivery.
  - title: Customizable
